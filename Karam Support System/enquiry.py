			...
			<div id="container">
				...
				<div id="main">	
					<div style="width:100%;height:800px;margin-top:50px">
							...
							<tr>
							 <td colspan="2" style="font-size:30px; color:blue; text-align:center;">Enquiry Form</td>
							</tr>
						   ...
						   <tr>
							...
							<td>
							 <textarea cols=30 rows=3 maxlength=100 name="address">
							 </textarea>
							</td>
						   </tr>
						   ...
						   <tr>
							<td>Enquiry Text:</td>
							<td>
								<textarea cols=40 rows=10 maxlength=500 name="enquirytext">
								</textarea>
							</td>
						   </tr>

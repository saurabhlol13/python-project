...
<form action="savenotification.py" method="post">
	<div id="outer">
		...
		<div id="container">
			<h2 style="color:navy; text-align:center; ">Ticket Management</h2>
...
cmd=con.cursor()
cmd.execute("select * from ticket")
res=cmd.fetchall()
for row in res:
	...
	print "<td>",row[4],"</td>"
	print "<td>",row[5],"</td>"
	print"<td><a href='upadteticket.py'>Update</td>"
	print "<td><a href='ticketdelete.py?id=",row[0],"'>Delete</a></td>"

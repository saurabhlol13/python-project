...
<form action="savenotification.py" method="post">
	<div id="outer">
		...
		<div id="container">
			<h2 style="color:navy; text-align:center; ">Feedback Management</h2>
...
cmd=con.cursor()
cmd.execute("select * from feedback order by id")
res=cmd.fetchall()
for row in res:
	...
	print "<td><a href='deletefeedback.py?id=",row[0],"'>Delete</a></td></tr>"
print """</table>
		</div>
		<div id="footer">
